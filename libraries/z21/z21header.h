...
//#define Z21bcRailcom         0x00000004    //zukuenftige Erweiterung (siehe Z21 Protokoll V1.05)
#define Z21bcSystemInfo      0x00000100
#define Z21bcSystemInfo_s        B00000100

#define Z21bcNetAll          0x00010000 // Alles, auch alle Loks ohne vorher die Lokadresse abonnieren zu muessen (fuer PC Steuerung)

...
*/
//**************************************************************
#define Z21ResetPin 39  //Reset Pin bei Neustart betätigen um Standard IP zu setzten!
#define Z21ButtonPin Z21ResetPin  //Pin where the Button is conected
...
#define maxIP 8        //Speichergröße für IP-Adressen (max Clients)
#else 
#define maxIP 15        //Speichergröße für IP-Adressen (max Clients)
#endif

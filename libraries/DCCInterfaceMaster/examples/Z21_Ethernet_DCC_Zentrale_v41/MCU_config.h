...
#define ShortLed 43     //LED to show Short
...
#else
#define GoIntPin 46   //Pin for second Booster like TLE5205
#define ShortIntPin 45  //Pin for second Booster like TLE5205 (detect HIGH)
#endif
